      ...
      <div className="min-h-screen bg-[#1CA774]">
        <div className="pb-28">
          <div className="px-4 font-[EXO] py-10">
            <h2 className="text-3xl leading-[2rem] text-white text-center font-mitr">
              Cookie Planet ID Card
            </h2>
            <p className="font-semibold text-[1.85rem] leading-none text-white text-center font-mitr mt-2">
              No. {sequence_no}
            </p>
