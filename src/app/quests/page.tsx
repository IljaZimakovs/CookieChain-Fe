      ...
      <div className="bg-[#1CA774] bg-[url('/images/sky_effect.png')] bg-[length:contain] flex flex-col min-h-screen">
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="pt-10 px-5 flex items-center justify-center flex-col w-full text-white">
            ...
            />
            <p className="font-medium mt-4 leading-[0.875rem] font-mitr">
              {user_name}{" "}
            </p>
            <div className="w-full relative mt-8">
              ...
              />
              <p className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white font-semibold text-lg font-mitr">
